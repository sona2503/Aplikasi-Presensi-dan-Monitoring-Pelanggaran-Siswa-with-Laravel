        ...
        <aside id="sidebar">
            ...
            <ul class="sidebar-nav">
                <li class="sidebar-item">
                    <a href="{{ route('PilihKelasAbsensiAdm') }}" class="sidebar-link">
                        <i class="lni lni-notepad"></i>
                        <span>Presensi </span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="{{ route('TampilPelanggaranAdm') }}"  class="sidebar-link">
                        <i class="lni lni-book"></i>
                        <span>Pelanggaran</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="{{ route('TampilUserAdm') }}" class="sidebar-link">
                        <i class="lni lni-user"></i>
                        <span>Tambah User</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="{{ route('TampilKelasAdm') }}"  class="sidebar-link">
                         <i class="lni lni-home"></i>
                        <span>Tambah Kelas</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="{{ route('TampilGuruAdm') }}" class="sidebar-link">
                        <i class="lni lni-graduation"></i>
                        <span>Tambah Guru</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="{{ route('PilihKelas') }}" class="sidebar-link">
                        <i class="lni lni-mailchimp"></i>
                        <span>Tambah Siswa</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="{{ route('Analisa') }}"  class="sidebar-link">
                        <i class="lni lni-bar-chart"></i>
                        <span>Diagram Pelanggaran</span>
                    </a>
                </li>
            </ul>
        </aside>
