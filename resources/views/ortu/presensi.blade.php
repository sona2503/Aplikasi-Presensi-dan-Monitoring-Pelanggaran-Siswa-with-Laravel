...
<div class="container">
    <div class="row mt-5">
        <div class="container">
            ...
            <!-- Form Pilihan Bulan -->
            <form action="{{ route('LihatAbsenOrtu') }}" method="GET" class="mb-4 mt-3">
                <div class="row">
                    <div class="col-md-4">
            ...
            <div class="container">
                <div class="col">
                    <a class="btn btn-primary" href="{{ route('CetakPresensiOrtu', ['bulan' => request('bulan')]) }}" role="button">Cetak</a>
                </div>
            </div>
        </div>
    </div>
